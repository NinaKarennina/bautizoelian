...
`;
  ...
  form.addEventListener('submit', async (e)=>{
    ...
    try{
      await fetch("https://script.google.com/macros/s/AKfycbyRNt3jWoIcSlOnxU4UhWv8W_5nOJcv8R-TP7xE6tT21p_pcMLmHAvNa2JlsZCKSqP3/exec", { method:'POST', body: fd, mode:'no-cors' });
