...
`;
  ...
  form.addEventListener('submit', async (e)=>{
    ...
    try{
      await fetch("https://script.google.com/macros/s/AKfycbzjS_LMAqBJ7-HC5mttzsVnhfbbjoDJsSlwU6QUCYzbVdowBGlf-EgKd6xxL8zTkNZc/exec", { method:'POST', body: fd, mode:'no-cors' });
